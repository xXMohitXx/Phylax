...
const tiers = [
    ...
    },
    {
        ...
        price: '$49',
        interval: '/month',
        description: 'For teams that need automated cloud validation.',
        features: [
            'Everything in Open Source',
            'Cloud dataset replay engine',
    ...
    },
    {
        ...
        price: '$299',
        interval: '/month',
        description: 'For growing AI engineering teams requiring collaboration.',
        features: [
            'Everything in Pro',
    ...
    },
    {
        ...
        price: '$2,000+',
        interval: '/month',
        description: 'Custom deployments and compliance for large organizations.',
        features: [
            'Everything in Team',
            'VPC / Private cloud deployment',
            'SOC2 / HIPAA compliance packs',
            'Dedicated Slack channel',
            'Custom SLAs',
        ],
        cta: 'Contact Sales',
        href: 'mailto:sales@phylax.dev',
        highlighted: false,
    },
];
