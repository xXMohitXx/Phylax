...
export default function Axis1Page() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <CodeBlock language="bash" title="Directory Structure" code={`phylax/_internal/expectations/
...
└── documentation.py     # Phase 5: Auto-generated docs`} />
      ...
      <CodeBlock language="python" title="Base Rules" code={`from phylax import MustIncludeRule, MustNotIncludeRule, MaxLatencyRule, MinTokensRule
...
MinTokensRule(50)              # Must generate at least 50 tokens`} />
      ...
      <CodeBlock language="python" title="Composition" code={`from phylax import AndGroup, OrGroup, NotGroup
...
NotGroup([MustNotIncludeRule("error")])`} />
      ...
      <CodeBlock language="python" title="Conditionals" code={`from phylax import when, InputContains, ModelEquals
...
when(ModelEquals("gpt-4"), then=MaxLatencyRule(2000))`} />
      ...
      <CodeBlock language="python" title="Scoping" code={`from phylax import for_node, for_provider, for_stage, for_tool
...
for_tool("fetch_db", MustIncludeRule("query"))`} />
      ...
      <CodeBlock language="python" title="Templates" code={`from phylax import register_template, get_template_rules
