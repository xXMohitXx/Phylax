...
export default function DatasetContractsPage() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <CodeBlock language="yaml" title="datasets/support_bot.yaml" code={`dataset: support_bot
cases:
  ...
  - input: "What is your return policy?"
    expectations:
      ...
      <CodeBlock language="python" title="dataset_usage.py" code={`from phylax import (
...
json_report = format_json_report(result)`} />
      ...
      <CodeBlock language="bash" title="Terminal" code={`# Run a dataset contract
...
# ❌ 1 of 3 cases failed. Exit code 1.`} />
      ...
      <CodeBlock language="python" title="diff_engine.py" code={`from phylax import (
...
json_diff = format_diff_json(diff)`} />
      ...
      <CodeBlock language="yaml" title=".github/workflows/dataset.yml" code={`name: Dataset Contract CI
