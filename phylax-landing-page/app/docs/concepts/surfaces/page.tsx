...
export default function SurfacesPage() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <CodeBlock language="python" title="structured_output.py" code={CODE_BLOCK_0} />
      ...
      <CodeBlock language="python" title="tool_enforcement.py" code={CODE_BLOCK_1} />

      <h2 className="text-2xl font-semibold text-coffee-bean mt-8 mb-4">Execution Trace Enforcement</h2>
      <CodeBlock language="python" title="execution_enforcement.py" code={CODE_BLOCK_2} />
      ...
      <CodeBlock language="python" title="stability.py" code={CODE_BLOCK_3} />
      ...
      <CodeBlock language="python" title="rag_enforcement.py" code={CODE_BLOCK_4} />

      <h2 className="text-2xl font-semibold text-coffee-bean mt-8 mb-4">Public API Imports</h2>
      <CodeBlock language="python" title="imports.py" code={CODE_BLOCK_5} />
    </div>
  );
}
