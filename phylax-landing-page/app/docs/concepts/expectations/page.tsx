...
export default function ExpectationsPage() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <CodeBlock language="python" title="expectations.py" code={`from phylax import trace, expect
...
def customer_support(query):
    return llm.generate(query)`} />
      ...
      <CodeBlock language="python" title="composition.py" code={`from phylax import (
    trace, expect,
...
def handle(message):
    ...`} />
      ...
      <CodeBlock language="python" title="conditionals.py" code={`from phylax import (
    trace, expect, when,
...
#             MetadataEquals, FlagSet`} />
      ...
      <CodeBlock language="python" title="scoping.py" code={`from phylax import (
...
stage_rule = for_stage("validation", MustIncludeRule("approved"))`} />
      ...
      <CodeBlock language="python" title="templates.py" code={`from phylax import (
...
rules = get_template_rules("customer_support")`} />
      ...
      <CodeBlock language="python" title="documentation.py" code={`from phylax import (
