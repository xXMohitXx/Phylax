...
export default function AgentTestingPage() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <CodeBlock language="python" title="agent_pipeline.py" code={`from phylax import trace, expect, execution
...
# If 'research' fails, 'validate' and 'respond' are marked tainted`} />
      ...
      <CodeBlock language="python" title="scoped_rules.py" code={`from phylax import for_node, for_provider, for_stage
...
validation_rule = for_stage("validation", MustIncludeRule("approved"))`} />
      ...
      <CodeBlock language="python" title="localization.py" code={`from phylax import ExecutionGraph
